...
\newcommand{\getfilehash}[1]{\captureshell{cpp #1.auto -dD -P -fpreprocessed | tr -d '[:space:]' | md5sum | cut -c-6}}
\newcommand{\inputcode}[2]{
    \IfFileExists{#2.auto}{
        \subsection[#1]{#1 \footnotesize{[\texttt{\getfilehash{#2}}]}}
        \vspace{-.2cm}
...
\newcommand{\inputcodemanualhash}[3]{
    \subsection[#1]{#1 \footnotesize{[\texttt{#3}]}}
    \vspace{-.2cm}
    \lstinputlisting{#2}
}
