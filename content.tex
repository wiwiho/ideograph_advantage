...
Default code: Basic \getfilehash{Basic/template_basic.cpp}\\
Square: \verb/i+<esc>25A---+<esc>o|<esc>25A   |<esc>ggVGyG35pGdd/

%\inputcode{Default Code}{Basic/template.cpp}
\inputcodemanualhash{.vimrc}{Basic/vimrc}{9b4074}
\inputcode{Debug}{Basic/debug.cpp}
...
\inputnote{LP Dual}{Math/LPDual.tex}
...
\inputcode{Berlekamp-Massey}{Math/Berlekamp_Massey.cpp}
...
\inputcode{Suffix Array}{String/SAIS.cpp}
...
\inputcode{Python Misc}{Misc/Python.py}
...
\begin{center}
    \begin{tikzpicture}
        \draw[step=0.5, gray, thin] (0,0) grid (9.0, 2);
    \end{tikzpicture}
\end{center}
